export const BASE_URL = 'http://54.169.106.52:8080/api/v1';

// Testing configurations
export const OPTIONS = {
  stages: [
    { duration: '15s', target: 100 },   // Ramp up to 10 users over 15 seconds
    { duration: '30s', target: 100 },    // Stay at 10 users for 30 seconds
