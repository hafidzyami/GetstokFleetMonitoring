...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/fuel-receipts": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "List of fuel receipts",
                        "schema": {
                            "$ref": "#/definitions/model.BaseResponse"
                        }
                    },
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Fuel receipt data",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.FuelReceiptCreateRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Successfully created fuel receipt",
                        "schema": {
                            "$ref": "#/definitions/model.BaseResponse"
                        }
                    },
        ...
        "/fuel-receipts/driver/{driver_id}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/fuel-receipts/{id}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Updated fuel receipt data",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.FuelReceiptUpdateRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "Successfully updated fuel receipt",
                        "schema": {
                            "$ref": "#/definitions/model.BaseResponse"
                        }
                    },
            ...
            "delete": {
                ...
                "responses": {
                    "200": {
                        "description": "Successfully deleted fuel receipt",
                        "schema": {
                            "$ref": "#/definitions/model.BaseResponse"
                        }
                    },
        ...
        "/idle-detections": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Idle detection data",
                        "schema": {
                            "$ref": "#/definitions/model.BaseResponse"
                        }
                    },
        ...
        "/idle-detections/active": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Active idle detection data",
                        "schema": {
                            "$ref": "#/definitions/model.BaseResponse"
                        }
                    },
        ...
        "/ocr/process": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "OCR request with base64 encoded image",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.OCRRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/route-deviations": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Route deviation data",
                        "schema": {
                            "$ref": "#/definitions/model.BaseResponse"
                        }
                    },
        ...
        "/trucks/mac/{macID}/idle-detections": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/trucks/{truckID}/positions": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Position history grouped by date",
                        "schema": {
                            "$ref": "#/definitions/model.BaseResponse"
                        }
                    },
        ...
        "/trucks/{truckID}/positions/limited": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
    ...
    "definitions": {
        ...
        "model.FuelReceiptCreateRequest": {
            "type": "object",
            "required": [
                "price",
                "product_name",
        ...
        "model.FuelReceiptUpdateRequest": {
            "type": "object",
            "properties": {
                "price": {
                    "type": "number"
        ...
        "model.OCRRequest": {
            ...
            "properties": {
                ...
                "lang": {
                    "description": "Optional language, default is \"ind\" (Indonesian)",
                    "type": "string"
                }
            }
        },
